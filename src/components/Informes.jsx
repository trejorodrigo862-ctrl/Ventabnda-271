...
const ReportContent = ({ individualProgress, users, goals, storeProgress, analysis, currentMonth }) => {
            ...
            <div className="my-6">
                ...
                <div className="space-y-5">
                    {vendedores.map(vendedor => {
                        ...
                        const vendedorGoal = (currentGoal?.userGoals?.[vendedor.id])?.metaPesos || 0;
                        return (
                            <div key={vendedor.id}>
                     ...
                     {cajeros.map(cajero => {
                        const cajeroGoals = (currentGoal?.userGoals?.[cajero.id]);
                        return (
