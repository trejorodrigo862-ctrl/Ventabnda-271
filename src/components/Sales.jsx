...
const StoreProgressForm = ({ onSubmit, onClose, progressToEdit }) => {
...
const Sales = () => {
    ...
    const handleFormSubmit = (data) => {
        if (progressToEdit) {
            isManager 
                ? updateStoreProgress(progressToEdit.id, data) 
                : updateIndividualProgress(progressToEdit.id, data);
        } else {
            isManager 
                ? addStoreProgress(data) 
                : addIndividualProgress(data);
        }
        handleCloseModal();
    };
    ...
    return (
        <div>
            ...
            <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={progressToEdit ? 'Editar Registro' : 'Nuevo Registro'}>
                {isManager
                    ? <StoreProgressForm onSubmit={handleFormSubmit} onClose={handleCloseModal} progressToEdit={progressToEdit} />
                    : <IndividualProgressForm onSubmit={handleFormSubmit} onClose={handleCloseModal} progressToEdit={progressToEdit} />
                }
            </Modal>
