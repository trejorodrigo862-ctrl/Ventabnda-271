  ...
  return (
    <div>
      ...
      <div className="space-y-8 max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-800">
          <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-4">Instalación de la App</h3>
          <PwaInstall />
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-6 text-center">
                 <a href="https://github.com/trejorodrigo862/VentaMcBanda" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-red-500 transition-colors">
